...
/**
 * GLFW constants (real GLFW values), used by the engine's Input keycode
 * constants. No actual windowing is provided on Android - the Android
 * container feeds input events directly.
 */
public final class GLFW {
    ...
    // printable keys (ASCII-compatible values)
