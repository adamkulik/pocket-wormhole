...
public class ModUtilities {
    ...
    public static Document parseStrictOrSloppyXML(CharSequence srcSeq, String srcDescription) throws IOException, JDOMException {
        ...
        try {
            SAXBuilder strictParser = com.pocketwormhole.android.SafeXML.builder();
        ...
        try {
            ...
            while ((item = zis.getNextEntry()) != null) {
                ...
                if (innerPath.indexOf("/") == -1) {
                    ...
                    try {
                        // xftl patch: don't warn on the wrong PNG format, we have different requirements
						/*
                    ...
                    for (Pattern ptn : oddCharPtns) {
                        ...
                        while (m.find()) {
                            ...
                            Character cObj = m.group(0).charAt(0);
    ...
    public static Report validateModXML(String text) {
        ...
        Document doc = null;
        try {
            SAXBuilder saxBuilder = com.pocketwormhole.android.SafeXML.builder();
    ...
    public static Document transformDocument(Document sourceDoc, InputStream stylesheet, final HashMap<String, byte[]> stylesheets) throws IOException {
        // Android port: XSLT transforms (Saxon-HE) are not supported.
        // Vanilla FTL and most mods never use them.
        throw new IOException("XSLT mod transforms are not supported in this build");
    }
